...
const Footer = () => {
	return (
		<div className="footer">
			<div>&copy; Gianpiero Bozza - GitHub repository: <Link href="https://github.com/gianpierobozza/r-r-weather-app" color="inherit" target="_blank" rel="noopener">github.com/gianpierobozza/r-r-weather-app</Link></div>
